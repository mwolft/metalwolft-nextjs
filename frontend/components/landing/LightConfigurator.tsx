  ...
  return (
    <aside className={styles.card}>
      <div className={styles.header}>
        ...
        <h2 className={styles.title}>Calcula tu siguiente paso en menos de un minuto</h2>
        <p className={styles.description}>
          Introduce el ancho y el alto aproximados de tu ventana y te llevamos
          a una ficha real para continuar con la configuracion completa.
        </p>
      </div>
      ...
      <p className={styles.note}>
        {targetSlug && productName
          ...
          : "Si no hay una ficha recomendada disponible, te llevaremos al catalogo de productos."}
      </p>
    </aside>
  );
}
